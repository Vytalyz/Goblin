...
def test_cli_main_success(isolated_repo: Path, capsys: pytest.CaptureFixture) -> None:
    argv = [
        ...
        "europe_open_impulse_retest_research",
        "--hypothesis",
        "EUR/USD shows mean-reverting behavior after >20pip moves at the EU open.",
        "--stop-loss-pips",
        "8",
        "--take-profit-pips",
        "24",
        ...
        "2.0",
        "--what-invalidates",
        "Trend regime overrides mean-reversion at session open.",
        "--hostile-regimes",
        "trend_high_vol,news_event",
        "--execution-assumptions",
        "M1 fills, OANDA spread, no slippage adjustment",
        "--non-deployable-when",
        "Spread > 2.0 pips or news within 15 minutes.",
        "--json",
    ]
    rc = gss.main(argv)
    assert rc == 0
