...
input string InpCandidateId = "AF-CAND-0241";
input string InpPacketRunId = "mt5run-20260325T042542Z";
input ulong InpMagicNumber = 200241;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 0.72000;
input double InpStopLossPips = 10.00000;
input double InpTakeProfitPips = 20.00000;
...
input double InpContinuationZscoreFloor = 0.17000;
input double InpContinuationZscoreCeiling = 0.88000;
input double InpContinuationRangePositionFloor = 0.64000;
...
input string InpAllowedHoursCsv = "13,14,15";
...
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0241__mt5run-20260325T042542Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0241__broker_history.csv";
input string InpDiagnosticWindowsRelativePath = "AgenticForex\\Audit\\AF-CAND-0241__diagnostic_tick_windows.csv";
input string InpDiagnosticTicksRelativePath = "AgenticForex\\Audit\\AF-CAND-0241__diagnostic_ticks.csv";
