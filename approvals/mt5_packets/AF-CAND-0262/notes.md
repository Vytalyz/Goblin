...
- MT5 packet run id: mt5run-20260325T040616Z
...
- Audit output path: <MT5_COMMON_FILES>/AgenticForex\Audit\AF-CAND-0262__mt5run-20260325T040616Z__audit.csv
- Broker history output path: <MT5_COMMON_FILES>/AgenticForex\Audit\AF-CAND-0262__broker_history.csv
- Deployed MQ5 path: data\state\mt5_automation_runtime\MQL5\Experts\AgenticForex\AF-CAND-0262.mq5
- Compiled EX5 path: data\state\mt5_automation_runtime\MQL5\Experts\AgenticForex\AF-CAND-0262.ex5
