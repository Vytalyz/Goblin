...
input string InpCandidateId = "AF-CAND-0242";
input string InpPacketRunId = "mt5run-20260325T042710Z";
input ulong InpMagicNumber = 200242;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 0.70000;
input double InpStopLossPips = 10.00000;
input double InpTakeProfitPips = 24.00000;
input double InpMaxSpreadPips = 2.20000;
...
input double InpTrendRet5Min = 0.00006000;
...
input double InpContinuationZscoreFloor = 0.15000;
input double InpContinuationZscoreCeiling = 0.88000;
input double InpContinuationRangePositionFloor = 0.62000;
...
input int InpHoldingBars = 126;
input string InpAllowedHoursCsv = "13,14,15,16";
...
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0242__mt5run-20260325T042710Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0242__broker_history.csv";
input string InpDiagnosticWindowsRelativePath = "AgenticForex\\Audit\\AF-CAND-0242__diagnostic_tick_windows.csv";
input string InpDiagnosticTicksRelativePath = "AgenticForex\\Audit\\AF-CAND-0242__diagnostic_ticks.csv";
