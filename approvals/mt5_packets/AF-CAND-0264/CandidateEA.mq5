...
input string InpCandidateId = "AF-CAND-0264";
input string InpPacketRunId = "mt5run-20260325T042413Z";
input ulong InpMagicNumber = 200264;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 0.84000;
input double InpStopLossPips = 14.00000;
input double InpTakeProfitPips = 26.00000;
...
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0264__mt5run-20260325T042413Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0264__broker_history.csv";
input string InpDiagnosticWindowsRelativePath = "AgenticForex\\Audit\\AF-CAND-0264__diagnostic_tick_windows.csv";
input string InpDiagnosticTicksRelativePath = "AgenticForex\\Audit\\AF-CAND-0264__diagnostic_ticks.csv";
