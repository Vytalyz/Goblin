...
input string InpCandidateId = "AF-CAND-0240";
input string InpPacketRunId = "mt5run-20260324T080435Z";
input ulong InpMagicNumber = 200240;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 0.76000;
input double InpStopLossPips = 7.00000;
input double InpTakeProfitPips = 15.50000;
...
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0240__mt5run-20260324T080435Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0240__broker_history.csv";
