...
input string InpCandidateId = "AF-CAND-0730";
input string InpPacketRunId = "mt5run-20260414T001718Z";
input ulong InpMagicNumber = 200730;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 2.50000;
input double InpStopLossPips = 8.00000;
input double InpTakeProfitPips = 25.00000;
...
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0730__mt5run-20260414T001718Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0730__broker_history.csv";
input string InpDiagnosticWindowsRelativePath = "AgenticForex\\Audit\\AF-CAND-0730__diagnostic_tick_windows.csv";
input string InpDiagnosticTicksRelativePath = "AgenticForex\\Audit\\AF-CAND-0730__diagnostic_ticks.csv";
