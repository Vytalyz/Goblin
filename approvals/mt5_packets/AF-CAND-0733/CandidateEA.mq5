...
input string InpCandidateId = "AF-CAND-0733";
input string InpPacketRunId = "mt5run-20260414T000642Z";
input ulong InpMagicNumber = 200733;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 2.50000;
input double InpStopLossPips = 7.00000;
input double InpTakeProfitPips = 24.00000;
input bool InpTrailingStopEnabled = false;
input double InpTrailingStopPips = 0.00000;
input double InpMaxSpreadPips = 1.50000;
input double InpMinVolatility20 = 0.00006000;
input double InpBreakoutZscoreFloor = 0.75000;
...
input int InpHoldingBars = 150;
input string InpAllowedHoursCsv = "8,9,10,11,12,13";
input string InpExcludedContextBucket = "";
input string InpRequiredVolatilityBucket = "";
input string InpEntryStyle = "volatility_breakout";
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0733__mt5run-20260414T000642Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0733__broker_history.csv";
input string InpDiagnosticWindowsRelativePath = "AgenticForex\\Audit\\AF-CAND-0733__diagnostic_tick_windows.csv";
input string InpDiagnosticTicksRelativePath = "AgenticForex\\Audit\\AF-CAND-0733__diagnostic_ticks.csv";
input string InpRuntimeSummaryRelativePath = "AgenticForex\\LiveDemo\\AF-CAND-0733\\runtime_summary.json";
input string InpSignalTraceRelativePath = "AgenticForex\\LiveDemo\\AF-CAND-0733\\signal_trace.csv";
input string InpBrokerTimezone = "Europe/Prague";
input bool InpShadowModeOnly = false;
...
void OnTick()
{
   ...
   if(HasOpenPosition())
   {
      ...
      if(InpTrailingStopEnabled && InpTrailingStopPips > 0 && g_has_open_trade)
      {
         ...
         {
            double pip_sz = ((_Digits == 3 || _Digits == 5) ? _Point * 10.0 : _Point);
