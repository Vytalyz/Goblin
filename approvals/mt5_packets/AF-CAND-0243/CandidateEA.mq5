...
input string InpCandidateId = "AF-CAND-0243";
input string InpPacketRunId = "mt5run-20260324T233150Z";
input ulong InpMagicNumber = 200243;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 0.69000;
input double InpStopLossPips = 11.00000;
input double InpTakeProfitPips = 24.00000;
input double InpMaxSpreadPips = 2.10000;
...
input double InpContinuationZscoreCeiling = 0.85000;
...
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0243__mt5run-20260324T233150Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0243__broker_history.csv";
input string InpDiagnosticWindowsRelativePath = "AgenticForex\\Audit\\AF-CAND-0243__diagnostic_tick_windows.csv";
input string InpDiagnosticTicksRelativePath = "AgenticForex\\Audit\\AF-CAND-0243__diagnostic_ticks.csv";
