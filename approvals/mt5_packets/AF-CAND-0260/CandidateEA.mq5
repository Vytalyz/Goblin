...
input string InpCandidateId = "AF-CAND-0260";
input string InpPacketRunId = "mt5run-20260325T024224Z";
input ulong InpMagicNumber = 200260;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 0.84000;
input double InpStopLossPips = 8.00000;
input double InpTakeProfitPips = 16.00000;
input double InpMaxSpreadPips = 2.40000;
input double InpMinVolatility20 = 0.00006000;
input double InpBreakoutZscoreFloor = 0.55000;
...
input double InpTrendRet5Min = 0.00008000;
input double InpPullbackZscoreLimit = 0.45000;
input double InpRetestZscoreLimit = 0.36000;
input double InpRetestRangePositionFloor = 0.56000;
...
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0260__mt5run-20260325T024224Z__audit.csv";
input string InpBrokerHistoryRelativePath = "AgenticForex\\Audit\\AF-CAND-0260__broker_history.csv";
input string InpDiagnosticWindowsRelativePath = "AgenticForex\\Audit\\AF-CAND-0260__diagnostic_tick_windows.csv";
input string InpDiagnosticTicksRelativePath = "AgenticForex\\Audit\\AF-CAND-0260__diagnostic_ticks.csv";
