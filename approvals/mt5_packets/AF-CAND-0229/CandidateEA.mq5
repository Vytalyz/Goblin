...
input string InpCandidateId = "AF-CAND-0229";
input string InpPacketRunId = "mt5run-20260324T005843Z";
input ulong InpMagicNumber = 200229;
input double InpFixedLots = 5.00;
input double InpSignalThreshold = 0.90000;
input double InpStopLossPips = 5.00000;
input double InpTakeProfitPips = 8.70000;
input double InpMaxSpreadPips = 2.40000;
input double InpMinVolatility20 = 0.00005000;
input double InpBreakoutZscoreFloor = 0.56000;
...
input double InpTrendRet5Min = 0.00009000;
input double InpPullbackZscoreLimit = 0.45000;
input double InpRetestZscoreLimit = 0.33000;
...
input string InpEntryStyle = "overlap_event_retest_breakout";
input string InpAuditRelativePath = "AgenticForex\\Audit\\AF-CAND-0229__mt5run-20260324T005843Z__audit.csv";
...
int GenerateSignal()
{
   ...
   double range_high_10 = MaxValue(closes, 1, 10);
   double range_low_10 = MinValue(closes, 1, 10);
...
{
   string parts[];
   int count = StringSplit(InpAuditRelativePath, '\\', parts);
   if(count <= 1)
      return true;
   string current = "";
